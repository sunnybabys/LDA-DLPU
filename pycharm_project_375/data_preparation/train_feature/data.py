...
dis_sim = pd.read_excel(dir_path + 'MNDR-disease semantic similarity matrix.xls',index_col=0).values
dis_sim = torch.from_numpy(dis_sim)


#2. load RNA functional similarity
r_sim = pd.read_excel(dir_path + 'MNDR-lncRNA functional similarity matrix.xls',index_col=0).values
